...
\begin{figure*}[tp!]
  \includegraphics[width=\textwidth]{traversal_visit_algo_figure.pdf}  
  \caption{
...
\begin{figure}[tp!]
  \includegraphics[width=\columnwidth]{traversal_funnel_algo_figure.pdf}
  \caption{
...
\begin{figure}[tp!]
  \includegraphics[width=\columnwidth]{centrality_measures.pdf}
  \caption{
...
\end{figure}
\begin{figure}[tp!]
  \includegraphics[width=\columnwidth]{popularity_funnels.pdf}
  \caption{

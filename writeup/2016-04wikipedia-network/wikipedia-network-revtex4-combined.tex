...
as a flow, 
With accumulated references, cycles, and path-connected groups, we can explore how the many articles in Wikipedia are organized and related.
...
\begin{figure}[tp!]
  ...
  \caption{
    ...
    distribution using the Maximum Likelihood Estimator with xmin as the in-degree minimizing Kolmogorov-Smirnov distance. We find xmin to be 5 links with a corresponding power law rank exponent $\alpha = 2.4$ and a size exponent $\gamma = 1.4$.
}

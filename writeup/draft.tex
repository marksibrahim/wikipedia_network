...
\centering
    ...
    \begin{subfigure}[b]{\textwidth}
        \includegraphics[width=\textwidth]{graphics/top_1k_100_pages.png}
    \end{subfigure}
\end{figure}

\red{[[change title from "pages" to "articles" for consistency]]} \\
\red{[[justify scale-free with log-log or power measure]]} \\

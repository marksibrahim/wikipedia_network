...
\begin{figure*}[tp!]
  ...
  We rank each article by the number of direct first links to the article (indegree). 
  \label{fig:ndegree list}

\end{figure*}
The highest ranking article by indegree is 
...
are not high-ranking by indegree.
...
one direct first link. The average indegree 
...
9. Overall the indegree appears scale-free with an r value of -0.98 as a linear log-log fit and a power law exponent of -0.79. 

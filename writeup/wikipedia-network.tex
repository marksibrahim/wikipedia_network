...
The structure of Wikipedia's Flrst Link Network
}
...
Philosophy funnels more paths than any other article by two orders of magnitude. 
...
%TODO:
% Abstract 
    % In traversing every path, we measure ?
    % Our findings... braided network (what does this mean?)
% Formatting
    % incorporate into template
% Intro
    % add month to monthly view stats
% Method
...
site in the world, surpassing 18 billion page views and 11 million edits in a single month.
...
\cite{geo_basins, dodds} and describe the organization of 

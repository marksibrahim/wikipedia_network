"""creates nth part of first link network using nth piece of xml dump"""
#takes a file number, stores nth first link network as json
import xml.etree.ElementTree as ET
import first_link_txt, gc, json, string, sys
#depends on first link extractor script "first_link_txt"
...
def return_file_list():
    """returns list of smallxx.xml files"""
...
if __name__ == "__main__":
    ...
    #list of 112 files
    full_file_list = return_file_list()
    
    #variables 
    file_num = int(sys.argv[1])
    data_path = "/users/m/s/msibrahi/full_wiki_data/" + full_file_list[file_num] + ".xml"
    out_path = "/users/m/s/msibrahi/v4/results/true_flnetwork/" + str(file_num) + ".json"
